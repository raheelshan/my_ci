...
<link rel="stylesheet" href="<?php echo base_url();?>css/uniform.default.css">
<link rel="stylesheet" href="<?php echo base_url();?>css/bootstrap.datepicker.css">
<link rel="stylesheet" href="<?php echo base_url();?>css/jquery.cleditor.css">
<link rel="stylesheet" href="<?php echo base_url();?>css/jquery.plupload.queue.css">
<link rel="stylesheet" href="<?php echo base_url();?>css/jquery.tagsinput.css">
<link rel="stylesheet" href="<?php echo base_url();?>css/jquery.ui.plupload.css">
...
<div class="style-toggler">
	<img src="<?php echo base_url();?>img/icons/fugue/color.png" alt="" class='tip' title="Toggle style-switcher" data-placement="right">
</div>					
		...
		<ul class='mini'>
			<li class='dropdown dropdown-noclose supportContainer'>
				<a href="#" class='dropdown-toggle' data-toggle="dropdown">
					<img src="<?php echo base_url();?>img/icons/fugue/book-question.png" alt="">
					Support tickets
				...
				<ul class="dropdown-menu pull-right custom custom-dark">
					<li class='custom'>
						...
						<div class="action">
							<div class="btn-group">
								<a href="#" class='tip btn btn-mini' title="Show ticket"><img src="<?php echo base_url();?>img/icons/fugue/magnifier.png" alt=""></a>
								<a href="#" class='tip btn btn-mini' title="Delete ticket"><img src="<?php echo base_url();?>img/icons/fugue/cross.png" alt=""></a>
							</div>
						</div>
					</li>
					<li class='custom'>
			...
			<li class='dropdown pendingContainer'>
				<a href="#" data-toggle="dropdown" class='dropdown-toggle'>
					<img src="<?php echo base_url();?>img/icons/fugue/document-task.png" alt="">
					Pending orders
				...
				<ul class="dropdown-menu pull-right custom custom-dark">
					<li class='custom'>
						...
						<div class="action">
							<div class="btn-group">
								<a href="#" class='tip btn btn-mini' title="Show order"><img src="<?php echo base_url();?>img/icons/fugue/magnifier.png" alt=""></a>
								<a href="#" class='tip btn btn-mini' title="Delete order"><img src="<?php echo base_url();?>img/icons/fugue/cross.png" alt=""></a>
							</div>
						</div>
					</li>
				</ul>
			...
			<li class='dropdown messageContainer'>
				<a href="#" class='dropdown-toggle' data-toggle='dropdown'>
					<img src="<?php echo base_url();?>img/icons/fugue/balloons-white.png" alt="">
					Messages
				...
				<ul class="dropdown-menu pull-right custom custom-dark">
					<li class='custom'>
						...
						<div class="action">
							<div class="btn-group">
								<a href="#" class='tip btn btn-mini' title="Show message"><img src="<?php echo base_url();?>img/icons/fugue/magnifier.png" alt=""></a>
								<a href="#" class='tip btn btn-mini' title="Reply message"><img src="<?php echo base_url();?>img/icons/fugue/mail-reply.png" alt=""></a>
							</div>
						</div>
					</li>
				</ul>
			...
			<li>
				<a href="#">
					<img src="<?php echo base_url();?>img/icons/fugue/gear.png" alt="">
					Settings
				</a>
			</li>
			<li>
				<a href="index.html">
					<img src="<?php echo base_url();?>img/icons/fugue/control-power.png" alt="">
					Logout
				</a>
			</li>
		</ul>
		...
		<ul class='main-nav'>
			...
			<li class='active open'>
				<a href="#" class='light toggle-collapsed'>
					...
					Tables
					<img src="<?php echo base_url();?>img/toggle-subnav-up-white.png" alt="">
				</a>
			...
			<li>
				<a href="#" class='light toggle-collapsed'>
					...
					Interface Elements
					<img src="<?php echo base_url();?>img/toggle-subnav-down.png" alt="">
				</a>
...
<script src="<?php echo base_url();?>js/plupload/plupload.full.js"></script>
<script src="<?php echo base_url();?>js/plupload/jquery.plupload.queue/jquery.plupload.queue.js"></script>
<script src="<?php echo base_url();?>js/jquery.cleditor.min.js"></script>
<script src="<?php echo base_url();?>js/jquery.inputmask.min.js"></script>
...
<script src="<?php echo base_url();?>js/jquery.textareaCounter.plugin.js"></script>
<script src="<?php echo base_url();?>js/ui.spinner.js"></script>
